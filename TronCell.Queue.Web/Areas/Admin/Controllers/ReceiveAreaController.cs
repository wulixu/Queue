...
namespace TronCell.Queue.Web.Areas.Admin.Controllers
{
    ...
    public class ReceiveAreaController : Controller
    {
        ...
        // GET: /Admin/ReceiveArea/Details/5
        ...
        // GET: /Admin/ReceiveArea/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: /Admin/ReceiveArea/Create
        // 为了防止“过多发布”攻击，请启用要绑定到的特定属性，有关 
        // 详细信息，请参阅 http://go.microsoft.com/fwlink/?LinkId=317598。
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Create([Bind(Include="ReceiveAreaId,AreaName,Description,Category")] ReceiveArea receivearea)
        {
        ...
        // POST: /Admin/ReceiveArea/Edit/5
        // 为了防止“过多发布”攻击，请启用要绑定到的特定属性，有关 
        // 详细信息，请参阅 http://go.microsoft.com/fwlink/?LinkId=317598。
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include="ReceiveAreaId,AreaName,Description,Category")] ReceiveArea receivearea)
        {
            if (ModelState.IsValid)
            {
        ...
        // GET: /Admin/ReceiveArea/Delete/5
        ...
        // POST: /Admin/ReceiveArea/Delete/5
